...
<!-- http://fordev22.com/ -->
  <aside class="main-sidebar sidebar-light-navy elevation-4">
    ...
    <a href="" class="brand-link bg-navy">      
      <span class="brand-text font-weight-light">ร้านค้าสหการณ์วิทยาลัยเทคนิคสัตหีบ</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="index.php" target="_bank" class="d-block">TATC-SHOP</a>
        </div>
      </div>      
      <!-- Sidebar Menu -->
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar nav-child-indent flex-column" data-widget="treeview" role="menu" data-accordion="false">               
          ...
          <li class="nav-item" >
            <a href="index.php?page=member" class="nav-link">
              <i class="nav-icon fas fa-address-card"></i><p>สมาชิก</p>
            </a>
          </li>          
          <li class="nav-item" >
            <a href="index.php?page=user" class="nav-link">
              <i class="nav-icon fas fa-address-card"></i><p>เจ้าหน้าที่</p>
            </a>
          </li>
